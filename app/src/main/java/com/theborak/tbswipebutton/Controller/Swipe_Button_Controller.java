...
public class Swipe_Button_Controller extends AppCompatSeekBar {
    ...
    private TBSwipeButton swipe_button_view;
    ...
    public void setOnSwipeCompleteListener_forward_reverse(OnSwipeCompleteListener listener_forward_reverse, TBSwipeButton swipe_button_view) {
