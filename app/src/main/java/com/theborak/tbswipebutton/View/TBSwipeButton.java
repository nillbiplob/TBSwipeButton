...
import com.theborak.tbswipebutton.Controller.Swipe_Button_Controller;
import com.theborak.tbswipebutton.R;
import com.theborak.tbswipebutton.Util.Dimension_Util;
import com.theborak.tbswipebutton.Util.Drawable_Color_Util;
...
public class TBSwipeButton extends RelativeLayout implements SeekBar.OnSeekBarChangeListener {
    ...
    protected float swipeTextSize = Dimension_Util.spToPx(16,getContext());
    ...
    public TBSwipeButton(Context context) {
        super(context);
        set_default(null, 0);
    }

    public TBSwipeButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        set_default(attrs, 0);
    }

    public TBSwipeButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        set_default(attrs, defStyleAttr);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public TBSwipeButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void getAttributes(TypedArray attributes) {
        ...
        if (attributes.hasValue(R.styleable.SwipeButtonView_sb_stroke_bg_color)) {
            Drawable_Color_Util.setDrawableStroke(swipe_bg_drawable, strokeColor);
        }
    ...
    public void setThumbBackgroundColor(int color) {
        Drawable_Color_Util.setDrawableColor(thumb_bg_drawable, color);
    }

    public void setSwipeBackgroundColor(int color) {
        Drawable_Color_Util.setDrawableColor(swipe_bg_drawable, color);
    }
    ...
    public void setEnabled(boolean enabled) {
        ...
        Drawable_Color_Util.setDrawableColor(thumb_bg_drawable, swipe_thumb_bg_color);
        Drawable_Color_Util.setDrawableColor(swipe_bg_drawable, swipe_bg_color);
    }
}
